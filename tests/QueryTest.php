...
class QueryTest extends TestCase
{
    ...
    public function testQueryMethods()
    {
        ...
        // serialize()
        $result = $query->find('form#formTest');
        $this->assertEquals('text1=&password1=&text2=&checkbox2=&checkbox3=&radio=radio2&select1%5B%5D=option2&select1%5B%5D=Option+3&textarea1=Text+inside.&file1%5B%5D=&image1=',
                            $result->serialize(),
